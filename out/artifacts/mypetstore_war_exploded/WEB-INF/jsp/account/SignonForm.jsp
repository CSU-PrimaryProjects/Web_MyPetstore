...
<div class="wrapper cf">
	...
	<div>
		...
		<form  action="login"  method="post" id="commentform" />

		<p class="comment-form-author"><label for="author">Username<span class="required">*</span></label>
			<input id="author" type="text" name="username" value="" size="30" aria-required="true" /></p>
		<p class="comment-form-email"><label for="email">Password<span class="required">*</span></label> <input
				id="email" type="password" name="password" value="" size="30" aria-required="true" /></p>
		<p class="comment-form-url"><label for="url">Identify</label><input id="url" name="identity" type="text" value=""
																		   size="30" /></p>

		<div id="center-container">
			<p class="form-submit">
				<input type="submit" name="signon" value="Login" id="submit" />
